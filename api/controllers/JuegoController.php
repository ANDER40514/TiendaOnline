...
class JuegoController
{
        ...
        switch ($method) {
            ...
            case 'PUT':
                ...
                if ($id !== null) {
                    ...
                    echo json_encode(['error' => 'Falta el ID del juego']);
                }
                break;
    ...
    {
        $res = JuegoModel::obtenerPorId($id);
        http_response_code($res['ok'] ? 200 : 404);
        echo json_encode($res, JSON_UNESCAPED_UNICODE);
    }
    ...
    {
        $res = JuegoModel::actualizar($id, $input);
